...
1. เปิดลิงก์ในมือถือเครื่องแรก → ใส่ชื่อ → **สร้างห้องใหม่** → จดรหัสห้อง 4 หลัก
...
- ใครก็ตามที่มี **ลิงก์เว็บ** จะอ่าน/เขียนตาราง `pk_events` ได้ (ไม่มีระบบล็อกอิน)
  → เดาห้องคนอื่นได้ถ้ารู้รหัส 4 หลัก · เหมาะกับเล่นกับเพื่อน **ไม่ควรใช้กับเงินจริงจำนวนมาก**
